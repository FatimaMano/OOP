...
using System.IO;
using System.Data;
using Business_Application_Version_1_Class_in_C_Admin.BL;
        ...
        */
        ...
        static bool UserExist(string name, string password, string role,List<Candidate> candidatesList)
        {
            ...
            if (role == "Candidate")
            {
                ...
                {
                    if (candidatesList[idx].name = name && Candidates[idx].password = password)
                    {
                        flag = true;
                        break;
                    }
        ...
        // Candidate Functions
        static void addCandidate(List<Candidate> candidates, int idx)
        {
            Candidate candidate = new Candidate();

            setName(candidate);
            setPassword(candidate);
            setAcademicTest(candidate);
            setIntelligenceTest(candidate);
        ...
        static void setName(Candidate candidate)
        {
            Console.WriteLine("Enter name");
            candidate.name = isAlpha(Console.ReadLine());
        }

        static void setPassword(Candidate candidate)
        {
            Console.WriteLine("Create password");
            candidate.password = Console.ReadLine();
        }

        static void setAcademicTest(Candidate candidate)
        {
            Console.WriteLine("Add his Academic score");
            candidate.AcademicTest = IntegerValidation();
        }

        static void setIntelligenceTest(Candidate candidate)
        {
            Console.WriteLine("Add his Intelligence Test");
            candidate.IntelligenceTest = IntegerValidation();
        }
        ...
        static void StoreDataInOutputMode(string role)
        {
            if (role == "Candidate")
            {
                ...
                for (int idx = 0; idx < countUsers; idx++)
                {
                    WriteCandidateDataToFile(file, idx);
                }
            ...
            {
                WriteAdminDataToFile();
            }
        }

        static void WriteCandidateDataToFile(StreamWriter file, int idx)
        {
        ...
        static void WriteAdminDataToFile()
        {
        ...
        {
            using (StreamWriter sw = File.AppendText("C:\\Users\\HP\\sour.............................mmce\\repos\\Business Application Version 1 C#\\File Storage\\Admin.txt"))
            {
                sw.Write(data + ",");
            }
        }
        ...
        static void StoreDataCandidateInList(List<Candidate> candidatesList, Candidate candidate)
        {
            candidatesList.Add(candidate);
        }
        //static void StoreDataStaffInList();
        static Candidate takeInputWithoutRole()
        {
            Console.WriteLine("Enter Name: ");
            string name = Console.ReadLine();
            Console.WriteLine("Enter Password: ");
        ...
        static Candidate takeInputWithRule()
        {
            Console.WriteLine("Enter Name: ");
            string name = Console.ReadLine();
            Console.WriteLine("Enter Password: ");
