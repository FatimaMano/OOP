...
namespace Military_Selection_Management_System.BL
{
    public class Candidate : Person
    {
        ...
        public Candidate(string ID,string name, string password, string address, int age, double phoneNumber, string emailAddress, string role) : base(ID,name, password, address, age, phoneNumber, emailAddress, "Candidate")
        {
